...
<nav className="bg-gray-800">
  <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    <div className="relative flex h-16 items-center justify-between">
      ...
      />
      {/* Switch label */}
      <label htmlFor="checkbox" className="w-[50px] h-[25px] left-[12%] bg-slate-900 flex rounded-[50px] items-center justify-between p-1 relative transform scale-1 cursor-pointer label">
      ...
      <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        <div className="relative ml-3">
          ...
          <div className="hidden sm:ml-6 sm:block absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabIndex="-1">
